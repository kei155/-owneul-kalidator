...
const earlierOrEqualTester: Tester = {
  name: 'earlierOrEqual',
  defaultMessageOnFailure: ':param(은/는) :$0(와/과) 같거나 이른 날짜여야해요',
  handler: (value, extras, nullable, { fail }) => {
    ...
    return valueDate.isSame(compareDate) || valueDate.isBefore(compareDate)
  }
}

export default earlierOrEqualTester
