...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/formdata-polyfill/formdata.min.js":[function(require,module,exports) {
...
},{}],"node_modules/weakmap-polyfill/weakmap-polyfill.js":[function(require,module,exports) {
var global = arguments[3];
...
var is = {
  empty: function empty(__target) {
    var isEmpty = __target === undefined || __target === null || __target.length && __target.length === 0 || __target instanceof FileList && __target.length === 0;
    return isEmpty;
  },
...
var Kalidator = function () {
  function Kalidator(data, rules, messages) {
    ...
    this.$defaults = {
      ...
      testers: {
        required: function required(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        requiredIf: function requiredIf(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        requiredNotIf: function requiredNotIf(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        minLength: function minLength(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        maxLength: function maxLength(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        betweenLength: function betweenLength(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
          ...
          return _this.$defaults.testers.minLength(key, [minLength], data) && _this.$defaults.testers.maxLength(key, [maxLength], data);
        },
        minValue: function minValue(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        maxValue: function maxValue(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        betweenValue: function betweenValue(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
          ...
          return _this.$defaults.testers.minValue(key, minValue, data) && _this.$defaults.testers.maxValue(key, maxValue, data);
        },
        in: function _in(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
          ...
          var extraValueArray = extraValue.filter(function (ev) {
            return ev !== undefined && ev !== null;
          });
          var targetValue = Kalidator.getTargetValue(data, key);
          return extraValueArray.indexOf(targetValue) !== -1;
        },
        notIn: function notIn(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        empty: function empty(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        notEmpty: function notEmpty(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        number: function number(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        email: function email(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        date: function date(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        file: function file(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        earlierThan: function earlierThan(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
          ...
          var targetValue = Kalidator.getTargetValue(data, key);
          var compareValue = Kalidator.getTargetValue(data, extraValue[0]) !== null ? Kalidator.getTargetValue(data, extraValue[0]) : extraValue;
        ...
        earlierOrEqualThan: function earlierOrEqualThan(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        laterThan: function laterThan(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
        ...
        laterOrEqualThan: function laterOrEqualThan(key, extraValue, data) {
          if (extraValue === void 0) {
            extraValue = [];
          }
  ...
  Kalidator.prototype.applyZosa = function (targetString) {
    ...
    var checkpoints = ['(은/는)', '(이/가)', '(을/를)', '(과/와)', '(아/야)', '(이여/여)', '(이랑/랑)', '(으로/로)', '(으로서/로서)', '(으로써/로써)', '(으로부터/로부터)'];
  ...
  Kalidator.prototype.test = function (key, ruleString) {
    ...
    while (!paramAsteriskFlatten.some(function (paf) {
      return paf.indexOf('*') === -1;
    })) {
      _loop_1();
    }

    var testFailHandler = function testFailHandler(paramForRow) {
      var messageKey = paramForRow;
      var isNumericExist = messageKey.split('.').some(function (splited) {
        return _this.$is.number(splited);
      });

      if (isNumericExist) {
        messageKey = messageKey.split('.').map(function (splited) {
          return _this.$is.number(splited) ? '*' : splited;
        }).join('.');
      }

      var message = (_this.$messages[paramForRow + '.' + testerName] || _this.$messages[messageKey + '.' + testerName] || _this.$defaults.messages[testerName] || _this.$defaults.messages[messageKey] || '').replace(/:param/g, label || paramForRow).replace(/:value/g, _this.data[paramForRow]);
  ...
  Kalidator.prototype.setData = function (data) {
    ...
    if (data instanceof FormData) {
      ...
      for (var index = 0; index < inputs.length; index++) {
        ...
        var name = input.getAttribute('name') || 'noname';
        ...
        if (input instanceof HTMLInputElement) {
          ...
          if (selectedOptions.length > 1) {
            ...
            for (var index_1 = 0; index_1 < selectedOptions.length; index_1++) {
              this.data[name].push(selectedOptions[index_1].value);
            }
    ...
    var promises = Promise.all(Object.keys(this.$rules).map(function (paramName) {
      if (_this.$rules.hasOwnProperty(paramName)) {
        ...
        return ruleArray.map(function (ruleString) {
          ...
          var getFailMessage = function getFailMessage(paramForRow) {
            var messageKey = paramForRow;
            var isNumericExist = messageKey.split('.').some(function (splited) {
              return _this.$is.number(splited);
            });
            ...
            var message = (_this.$messages[paramForRow + '.' + testerName] || _this.$messages[messageKey + '.' + testerName] || _this.$defaults.messages[testerName] || _this.$defaults.messages[messageKey] || '').replace(/:param/g, label || paramForRow).replace(/:value/g, Kalidator.getTargetValue(_this.data, paramForRow));
        ...
        totalResult.forEach(function (resultList) {
          ...
          resultSet.forEach(function (result) {
            if (result.isPass !== true) {
              ...
              _this.errors[result.paramForRow] = _this.errors[result.paramForRow] || {};
              _this.errors[result.paramForRow][result.testerName] = result.failMessage;
            }
          });
        });
        return new Promise(function (resolve, reject) {
          if (_this.isPassed) {
            ...
            _this.firstErrorMessage = firstErrorBag[Object.keys(firstErrorBag)[0]];
            reject({
              errors: _this.errors,
...
},{"formdata-polyfill":"node_modules/formdata-polyfill/formdata.min.js","weakmap-polyfill":"node_modules/weakmap-polyfill/weakmap-polyfill.js","moment":"node_modules/moment/moment.js"}],"test.js":[function(require,module,exports) {
