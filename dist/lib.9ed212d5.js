...
var Kalidator = function () {
  function Kalidator(__data, __rules, __messages) {
    ...
    this.tester = {
      ...
      betweenValue: function betweenValue(__key, __extraValue, __data) {
        ...
        return _this.__isTestNotRequired('betweenValue', __key) || is.number(__data[__key]) && _this.tester.minValue(__key, __extraValue[0], __data) && _this.tester.maxValue(__key, __extraValue[1], __data);
      },
      ...
      email: function email(__key, __extraValue, __data) {
        ...
        return _this.__isTestNotRequired('email', __key) || __data[__key].match(/@/g) && __data[__key].match(/@/g).length === 1 && __data[__key][0] !== '@' && __data[__key][__data[__key].length - 1] !== '@';
      },
  ...
  Kalidator.prototype.__isTestNotRequired = function (__testerName, __dataKey) {
    return this.conditionalRequiredRules.indexOf(__testerName) === -1 && !this.__isRequired(__dataKey) && is.empty(this.data[__dataKey]);
  };
...
},{"@owneul/kate":"node_modules/@owneul/kate/dist/index.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","lib/index.ts"], null)
//# sourceMappingURL=/lib.9ed212d5.js.map