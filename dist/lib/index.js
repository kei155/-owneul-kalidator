...
var Kalidator = (function () {
    function Kalidator(__data, __rules, __messages) {
        ...
        this.tester = {
            ...
            betweenLength: function (__key, __extraValue, __data) {
                ...
                return (_this.__isTestNotRequired('betweenLength', __key) ||
                    (_this.tester.minLength(__key, __extraValue[0], __data) &&
                        _this.tester.maxLength(__key, __extraValue[1], __data)));
            },
            ...
            earlierThan: function (__key, __extraValue, __data) {
                ...
                return (_this.__isTestNotRequired('earlierThan', __key) ||
            ...
            laterThan: function (__key, __extraValue, __data) {
                ...
                return (_this.__isTestNotRequired('laterThan', __key) ||
                    (!isNaN(compareDate.getFullYear()) &&
                        !isNaN(valueDate.getFullYear()) &&
                        valueDate.getTime() > compareDate.getTime()));
            },
    ...
    Kalidator.prototype.test = function (__key, __tester) {
        ...
        if (!tester(param, extraValue, this.data)) {
            var message = (this.messages[param + '.' + testerName] ||
